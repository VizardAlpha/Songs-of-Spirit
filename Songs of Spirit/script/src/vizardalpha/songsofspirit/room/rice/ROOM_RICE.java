 ...
 */
public class ROOM_RICE extends RoomBlueprintIns<RiceInstance> {

	private final RiceConstructor furnisher;
	
	/**
	 * @param data helpful init data that we don't need to care too much about. It automates reading of the .txt files
	 * @throws IOException 
	 */
	public ROOM_RICE(RoomInitData data, RoomCategorySub block) throws IOException {
		super(0, data, "PREP_VINIFICATION", data.m.CATS.REFINERS);
		
		furnisher = new RiceConstructor(this, data);
	}

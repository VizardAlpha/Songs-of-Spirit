...
- Several titles added.
- Hunters will now produce animal corpses, so you'll need to use the "kitchen" to recover meat and leather.
- An improvement has been added to the hunter (see technologies).
...
- Accidents per year of pastures has been adjusted to match vanilla.
...
- The plank cost for supplies has been increased. 2 -> 3
...
## xx-xx-2024 5.0.0 Major
- Addition of 50 wooden planks to the starter.
- Fix the LandingParty. You start a new game with the items listed in LandingParty.
- You start the game with two new villagers.
- The throne building is larger than the vanilla building.
- Price Cap add for items, should help adjust item prices?. (To be tested)
- Addition of a new item, flour.
- New sandstone structure.
- 

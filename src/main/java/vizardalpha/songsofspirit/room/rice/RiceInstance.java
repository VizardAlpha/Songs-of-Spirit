...
class RiceInstance extends RoomInstance{
	 ...
	 * @param init
	 */
	protected RiceInstance(RoomBlueprintIns<? extends RoomInstance> blueprint, TmpArea area, RoomInit init) {
